...
async function displayTitleScreen() {
    ...
    bootScreen.innerHTML = "<h1>Noge Progs </h1>";
...
async function initUI() {
    ...
    window.term[0].term.writeln("\033[1m"+`Welcome to Noge Prods v${electron.remote.app.getVersion()} - Electron v${process.versions.electron}`+"\033[0m");
